...
public class TestTrackImport extends CMusicTestCase {
	...
	public void testWav() throws Exception {
		...
		assertTrue(track.getLength().getSampleCount() > 1000);
	}

	/*
	 * public void testOgg() throws Exception { ETrack track = getNewTrack();
	 * track.importFile("src/test/testaudio.ogg"); assertTrue(track.getLength()
	 * > 1000); }
	 * 
	 * public void testFlac() throws Exception { ETrack track = getNewTrack();
	 * track.importFile("src/test/testaudio.flac"); assertTrue(track.getLength()
	 * > 1000); }
	 */
