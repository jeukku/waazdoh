...
class codec_setup_info {
	...
	// Vorbis supports only short and long blocks, but allows the encoder to
	// choose the sizes
	...
	// different residue backends, etc. Each mode consists of a blocksize flag
	...
	int[] residue_type; // int residue_type[64] - this guy might change from
						// 0,1,2 for functions
	vorbis_info_residue0[] residue_param; // vorbis_info_residue
											// *residue_param[64] - data will
											// always fit into res0
