...
class vorbis_look_psy_global {
	...
	public vorbis_look_psy_global(float _ampmax, int _channels,
			vorbis_info_psy_global _gi, int[][] _coupling_pointlimit) {
	...
	public vorbis_look_psy_global(vorbis_look_psy_global src) {
		...
		this(src.ampmax, src.channels, new vorbis_info_psy_global(src.gi),
				src.coupling_pointlimit);
	}
