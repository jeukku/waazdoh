...
class private_state {
	...
	mdct_lookup[][] transform; // vorbis_look_transform **transform[2];// block,
								// type
	...
	public private_state() {
		...
		// backend_state.transform[0] =
		// _ogg_calloc(VI_TRANSFORMB,sizeof(*backend_state.transform[0]));
		// backend_state.transform[1] =
		// _ogg_calloc(VI_TRANSFORMB,sizeof(*backend_state.transform[1]));
		// MDCT is tranform 0
