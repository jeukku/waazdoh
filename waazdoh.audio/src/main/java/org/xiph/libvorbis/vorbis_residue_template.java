...
public class vorbis_residue_template {
	...
	public vorbis_residue_template(int _res_type, int _limit_type,
			vorbis_info_residue0 _res, static_codebook _book_aux,
			static_codebook _book_aux_managed, static_bookblock _books_base,
			static_bookblock _books_base_managed) {
	...
	public vorbis_residue_template(vorbis_residue_template src) {
		...
		this(src.res_type, src.limit_type, new vorbis_info_residue0(src.res),
				new static_codebook(src.book_aux), new static_codebook(
						src.book_aux_managed), new static_bookblock(
