...
public class BlockEncodeRequest {
	 ...
	 * @param skip
	 *            Number of samples to skip between samples(this should be equal
	 *            to number-of-channels minus 1.
	 * @param frameNumber
	...
	public int addInterleavedSamples(int[] newSamples, int offset,
			int addCount, int max) {
		// System.err.println("offset:addCount:max :: "
		// +offset+":"+addCount+":"+max);
