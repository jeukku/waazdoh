...
public class FLACStreamOutputStream implements FLACOutputStream, Closeable {
	...
	/**
	 * Constructor. Create a FLACStreamOutputStream using the given
	 * OutputStream.
	 * 
	 * @param out
	 *            OutputStream to write the FLAC stream to.
	 */
	...
	public long seek(long pos) {
		throw new UnsupportedOperationException(
				"seek(long) is not supported on by FLACStreamOutputStream");
	}
	...
	/**
	 * Get the current write position of this stream. If this stream cannot
	 * seek, this will return 0;
	 * 
